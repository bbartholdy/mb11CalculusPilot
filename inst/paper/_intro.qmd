...
and (2) passive diffusion as toxins are transferred from serum to saliva
...
of consumption or administration<!--cite e.g. injection or topical-->.
<!-- Additionally, alkaloids will spend shorter time in mouth during direct consumption than
during excretion through saliva, so we expect the second pathway to be more
feasible for detection. -->
...
The method we use in this study was developed in a previous study on dental
