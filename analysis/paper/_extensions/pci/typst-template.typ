...
// experiment with function to add title page
  let generate_titlepage() = {
    image("pci_logos/PCI_archaeo.png", width: 100%)
    v(0.2cm)
    table(
      align: (right, left),
      column-gutter: 10mm,
...
/*
  table(
    ...
    [
      ...
      *Cite as*\
      ...
      #v(5mm)
      *Correspondence*\
      #link("mailto:foobar@barfoo.com")[foobar\@barfoo.com] //#link("mailto:" + author.email)
      #v(5mm)
      *Peer-review*\
      Peer reviewed and recommended by PCIXXX
      #v(5mm)
  ...
  */
  ...
  set page(
    margin: 1in,
    header: if mode == "pretty" {
      generate_header(authors)
    },
    footer: if mode == "pretty" {
      generate_footer(volume, doi)
    },
  )
