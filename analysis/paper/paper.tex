...
population}
\author{Bjørn Peare Bartholdy\textsuperscript{1,*} \and Jørgen B. Hasselstrøm\textsuperscript{2} \and Lambert K. Sørensen\textsuperscript{2} \and Maia Casna\textsuperscript{1} \and Menno Hoogland\textsuperscript{1} \and Historisch Genootschap Beemster\textsuperscript{3} \and Amanda G. Henry\textsuperscript{1}}
\date{}
...
\end{abstract}
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[interior hidden, borderline west={3pt}{0pt}{shadecolor}, frame hidden, breakable, boxrule=0pt, sharp corners, enhanced]}{\end{tcolorbox}}\fi
...
(\url{https://doi.org/10.5281/zenodo.7648757}). Analysis scripts, and
...
\leavevmode\vadjust pre{\hypertarget{ref-aten400JaarBeemster2012}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-leuwProhibitionLegalizationDutch1994}{}}%
