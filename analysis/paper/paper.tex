...
\makeatother
\usepackage{xcolor}
\usepackage[top=10mm,bottom=10mm,left=30mm,heightrounded]{geometry}
...
dentition. Nicotine and/or cotinine was present in 56\% of individuals
...
historic documentation, such as rural populations, and especially
children and women.
\end{abstract}
...
\newgeometry{top=30mm,left=30mm}\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, sharp corners, breakable, boxrule=0pt, borderline west={3pt}{0pt}{shadecolor}, interior hidden, frame hidden]}{\end{tcolorbox}}\fi
