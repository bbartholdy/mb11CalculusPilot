...
nicotine, cotinine, caffeine, theophylline, and salicylic
acid in multiple individuals. The detection of these compounds was
...
of the upper respiratory tract, including chronic maxillary sinusities
...
We also observed a moderate positive correlation between chronic maxillary sinusitis and caffeine which
...
Because we targeted individuals with moderate-to-large calculus deposits,
it is likely a biased sample. The presence of calculus may increase the
...
in the burial environment.<!-- move to discussion in disseration: Here, *in vitro* studies may provide valuable insights-->
